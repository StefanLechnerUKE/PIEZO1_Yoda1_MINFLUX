...
% VF1714_15AA-CTL, 7 = VF1714_15AA-cytoD, 8 = VF1714_15AA-cytoD+yoda
   ...
   Exclude = [8 13 15 24 33 62 73 85 106]     %%trimers excluded because the signals are not likely in the plasma membrane
    ...
    load("A2094W_ALFAmGL_CTL_RawData.mat");
        ...
        Exclude = [23 25 31 34 46 50 72]'; %% trimers excluded because the signals are not likely in the plasma membrane
    ...
    load("A2094W_ALFAmGL_CYTOD_RawData.mat");
        ...
        Exclude = [4 5 7 8 16 18 19 27 39 43 45 51 54 56 61 71]'; %% trimers excluded because the signals are not likely in the plasma membrane
   
        elseif  DataSource == 5
    load("A2094W_ALFAmGL_CYTOD_Yoda_RawData.mat");
             myStruct = A2094W_ALFAmGL_CYTOD_Yoda_RawData;
             result.color = [1 0.6 0.6];
        Exclude = [2 8 11 15 18 25 29 31 32 34 35 38 40 59 71 75]'; %% trimers excluded because the signals are not likely in the plasma membrane

    elseif  DataSource == 6
    load("VF1714_15AA_ALFAmGL_CTL_RawData.mat");
             myStruct = VF1714_15AA_ALFAmGL_CTL_RawData;
             result.color = [1 0.6 0.6];
        Exclude = [7 9 11 38 76 83]'; %% trimers excluded because the signals are not likely in the plasma membrane    
    
    elseif  DataSource == 7
    load("VF1714_15AA_ALFAmGL_CYTOD_RawData.mat");
             myStruct = VF1714_15AA_ALFAmGL_CYTOD_RawData;
             result.color = [1 0.6 0.6];
        Exclude = [7 11 12 14 21 26 32 34 36 43 45 51 52 55 56 59 63 65 66 80 83 86 92 102 105 106 107 109 114 116]'; %% trimers excluded because the signals are not likely in the plasma membrane

            elseif  DataSource == 8
    load("VF1714_15AA_ALFAmGL_CYTOD_Yoda_RawData.mat");
             myStruct = VF1714_15AA_ALFAmGL_CYTOD_Yoda_RawData;
             result.color = [1 0.6 0.6];
        Exclude = [12 26 28 38]'; %% trimers excluded because the signals are not likely in the plasma membrane
